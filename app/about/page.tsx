...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="/" className="text-slate-700 hover:text-blue-900 transition-colors font-medium">홈</a>
              <a href="/about" className="text-blue-900 font-semibold">회사 소개</a>
            </div>
            <a 
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">회사 개요</h2>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">전략적 목적</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">시장 인텔리전스 및 검증</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">자동화된 리서치 우수성</h3>
              <p className="text-slate-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">구현 파트너십</h3>
              <p className="text-slate-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">전략적 조정 허브</h3>
              <p className="text-slate-700 leading-relaxed">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">핵심 운영 프레임워크</h2>
            <p className="text-xl text-slate-600">4단계 프로세스로 구성된 체계적인 접근 방식</p>
          </div>
          ...
          <div className="space-y-12">
            ...
            {/* Phase 2 */}
            <div className="bg-gradient-to-r from-amber-600 to-amber-500 text-white p-8 rounded-xl shadow-xl">
            ...
            {/* Phase 3 */}
            <div className="bg-gradient-to-r from-green-600 to-green-500 text-white p-8 rounded-xl shadow-xl">
              ...
              <div className="grid md:grid-cols-4 gap-4">
                <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm text-center">
                  ...
                  <p className="text-green-100">시장 기회 정의</p>
                </div>
                <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm text-center">
                  <div className="text-3xl font-bold mb-2">2</div>
                  <p className="text-green-100">포괄적 시장 진단</p>
                </div>
                <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm text-center">
                  <div className="text-3xl font-bold mb-2">3</div>
                  <p className="text-green-100">정량적 평가</p>
                </div>
                <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm text-center">
                  <div className="text-3xl font-bold mb-2">4</div>
                  <p className="text-green-100">전략적 권장사항</p>
                </div>
              </div>
            </div>

            {/* Phase 4 */}
            <div className="bg-gradient-to-r from-purple-600 to-purple-500 text-white p-8 rounded-xl shadow-xl">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-slate-900 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-200">검증된 결과로 입증되는 플랫폼의 가치</p>
          </div>

          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl font-bold mb-2">48시간</div>
              <div className="text-blue-200 font-medium">리서치 완료</div>
              <div className="text-sm text-blue-300 mt-1">vs. 수주 (전통적)</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold mb-2">70%</div>
              <div className="text-blue-200 font-medium">비용 절감</div>
              <div className="text-sm text-blue-300 mt-1">전통 컨설팅 대비</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-200 font-medium">시장 진입 성공률</div>
              <div className="text-sm text-blue-300 mt-1">구현 성공 비율</div>
            </div>
          </div>
        </div>
      </section>
